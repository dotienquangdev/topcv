  ...
  return (
    <>
      ...
      <div>
        ...
        <button onClick={() => handlePayment(10)}>Nạp 10,000đ</button>
        <button onClick={() => handlePayment(20)}>Nạp 20,000đ</button>
        <button onClick={() => handlePayment(50)}>Nạp 50,000đ</button>
      </div>
    </>
  );
}
